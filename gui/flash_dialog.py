...
class Ui_FlashDialog(object):
    def setupUi(self, FlashDialog):
        ...
        self.eraseFlashCheckbox = QtWidgets.QCheckBox(FlashDialog)
        self.eraseFlashCheckbox.setObjectName("eraseFlashCheckbox")
        self.verticalLayout.addWidget(self.eraseFlashCheckbox)
    ...
    def retranslateUi(self, FlashDialog):
        ...
        self.eraseFlashCheckbox.setText(_translate("FlashDialog", "Erase flash"))
